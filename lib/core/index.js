...
var SimpleWysiwyg = function (_aTemplate) {
  ...
  function SimpleWysiwyg(ele, settings) {
    ...
    _this.update();
    _this.selector = _this._getElementByQuery('.' + _this.data.classNames.SimpleWysiwygSource);
  ...
  _createClass(SimpleWysiwyg, [{
    ...
    value: function onInput() {
      var editor = this._getElementByQuery('.' + this.data.classNames.SimpleWysiwyg);
